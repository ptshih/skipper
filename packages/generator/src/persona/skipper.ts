...
BREAK (sheet: PLACE — the Grove Beach Bar and Grill; KIND — restaurant; the live details are resolved later, no side given. The name and the kind are yours to say; nothing else about THIS spot is — not its hours, its rating, what's good there, or where it sits):
