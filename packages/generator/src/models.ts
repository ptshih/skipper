...
export const SKIPPER_TTS_STYLE_PROMPT =
  'Read this aloud as a warm, easygoing river-boat tour captain talking to friends riding along in the car: unhurried and genuinely glad they came, a little playful and dry. Let the jokes land lightly without winking at them, and give the quiet, sincere lines room to breathe. Conversational and human, never a newscast.'
