...
Rules:
- A regional label is broad context, including gateway approaches. It does NOT establish that this stop is inside a park, beside a lake, near water, or on a particular valley floor. Those are specific local claims and require this stop's sheet; a historical event elsewhere cannot become "here" merely because it shares a region.
