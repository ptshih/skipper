...
**`docs/guides/app-store-submission.md`** — §15 owns the new round (§15d fixed demo OTP LIVE + verified;
all that remains is the Resubmit CLICK), §14 the first, §13 the store link; release stays MANUAL. RISK-1's real drive is STILL OWED.
