...
|---|---|
| **"stretches of *dead air* between stops that could've been filled with stories"** | the **downtime-callouts** feature — `docs/designs/downtime-callouts-spec.md` |
...
- **"Side quests" / recommended detours with directions.** The sharpest philosophical fork: Shaka
  *routes you* to detours (utility); our #4 skipper deliberately *won't name names* (the vagueness is
  the bit — `docs/designs/skipper-opinions-spec.md` §3.4). Keep the charm version — eyes open that we trade a
