...
2. **Score** the panel: GROUNDING (Opus, the cardinal-invariant gate) + LATERALITY (free, a grounding
   backstop — the direction of travel is unknown, so naming a side of the road is an ungrounded
   place-claim; the rule outlived the roam mode it was written for) + TTS-cleanliness (free
