  ...
  return (
    <div className="space-y-8">
      ...
      <Callout variant="info">
        ...
        Listening Review workspace (full clips, saved verdicts, technical checks) → tune (re-synth / regenerate) → explicitly approve → release to
