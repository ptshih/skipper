...
//   Zilla Slab    — constructed park-sign display slab (700)
//   Lora          — calligraphic screen slab for all body/UI text (400 / 600 / 700)
//   Overpass Mono — highway-sign / odometer numerals (400 / 600)
//
...
import { OverpassMono_400Regular, OverpassMono_600SemiBold } from '@expo-google-fonts/overpass-mono'
