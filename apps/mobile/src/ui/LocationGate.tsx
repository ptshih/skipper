// The location-permission gate, shared by the drive + roam screens — a "smart" composite
...
// caller passes its own flag shape (useDrive's two booleans vs useRoam's gate object) + handlers.
